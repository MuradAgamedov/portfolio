    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-edit"></i> Təhsil Redaktə Et
            </h1>
        </div>
    </div>
                        ...
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('title.' . $language->lang_code, $education->getTitle($language->lang_code)) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('university_name.' . $language->lang_code, $education->getUniversityName($language->lang_code)) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description[{{ $language->lang_code }}]" 
                                          ...
                                          required>{{ old('description.' . $language->lang_code, $education->getDescription($language->lang_code)) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ $education->status ? 'checked' : '' }}>
