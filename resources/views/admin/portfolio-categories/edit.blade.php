...
@section('title', 'Portfolio Kateqoriyasını Redaktə Et')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-edit"></i> Portfolio Kateqoriyasını Redaktə Et
            </h1>
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('title.' . $language->lang_code, $portfolioCategory->title[$language->lang_code] ?? '') }}"
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ (bool)$portfolioCategory->status ? 'checked' : '' }}>
