...
@section('title', 'Portfolio Kateqoriyaları')
                            ...
                            <tr data-id="{{ $category->id }}">
                                ...
                                <td>
                                    @php
                                        ...
                                        // echo "Status value: " . var_export($category->status, true) . "<br>";
                                        // echo "Status type: " . gettype($category->status) . "<br>";
                                    @endphp
                                    @if($category->status)
    ...
    if (sortableCategories) {
        new Sortable(sortableCategories, {
            ...
            onEnd: function(evt) {
                ...
                $.ajax({
                    url: '{{ route("admin.portfolio-categories.reorder") }}',
                    method: 'POST',
                    data: {
                        orders: orders,
