...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Adding feature to: {{ $pricingPlan->getTranslation('title', 'en') }}</p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.pricing-plans.features.store', $pricingPlan) }}" method="POST">
                @csrf
