    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-edit"></i> Sertifikatı Redaktə Et
            </h1>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.certificates.update', $certificate) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <label class="form-label">Sertifikat Şəkli</label>
                        ...
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" 
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('title.' . $language->lang_code, $certificate->getTitle($language->lang_code)) }}"
                                               required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('image_alt_text.' . $language->lang_code, $certificate->getImageAltText($language->lang_code)) }}"
                                               required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description[{{ $language->lang_code }}]" 
                                          ...
                                          rows="4"
                                          required>{{ old('description.' . $language->lang_code, $certificate->getDescription($language->lang_code)) }}</textarea>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="status" id="status" {{ $certificate->status ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    $('#imageInput').on('change', function() {
        ...
        if (file) {
            ...
            @if($certificate->image)
                $('#previewContainer').html('<img src="{{ $certificate->getImageUrl() }}" style="max-width: 100%; max-height: 120px; object-fit: contain;">');
            @else
