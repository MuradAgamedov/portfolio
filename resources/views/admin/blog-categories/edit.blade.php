...
@section('title', 'Blog Kateqoriyasını Redaktə Et')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-edit"></i> Blog Kateqoriyasını Redaktə Et
            </h1>
        </div>
    </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ (bool)$blogCategory->status ? 'checked' : '' }}>
