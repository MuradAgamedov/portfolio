    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <label class="form-label">İkon Şəkli <span class="text-danger">*</span></label>
                        <div class="icon-preview" id="iconPreview">
                            <i class="fas fa-image"></i>
                        </div>
                        <input type="file" name="icon" id="iconInput" class="form-control @error('icon') is-invalid @enderror" accept="image/*" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('icon_alt_text.' . $language->lang_code) }}"
                                               required>
