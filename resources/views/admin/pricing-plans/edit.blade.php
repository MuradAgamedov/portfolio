                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       value="{{ old('title_' . $language->lang_code, $pricingPlan->getTranslation('title', $language->lang_code)) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       value="{{ old('price_' . $language->lang_code, $pricingPlan->getTranslation('price', $language->lang_code)) }}"
