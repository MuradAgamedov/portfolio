...
@section('title', 'Peşəni Redaktə Et')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-edit"></i> Peşəni Redaktə Et
            </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.hero-professions.update', $profession->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="language-content {{ $index === 0 ? 'active' : '' }}" data-lang="{{ $language->lang_code }}">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('title.' . $language->lang_code, $profession->getTranslation('title', $language->lang_code)) }}"
                                   required>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ old('status', $profession->status) ? 'checked' : '' }}>
