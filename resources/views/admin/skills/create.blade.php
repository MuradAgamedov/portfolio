                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="percent-display" id="percentDisplay">50%</div>
                            <div class="progress-preview">
                                <div class="progress-bar-preview" id="progressPreview" style="width: 50%"></div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Bacarıq Yarat
                            </button>
                        </div>
                    </div>
                </div>
