                                                ...
                                                <div class="inner">
                                                    <div class="heading">
                                                        ...
                                                        <div class="date-of-time">
                                                                <span style="color: #ff014f; font-size: 12px; font-weight: 600; background: rgba(255,1,79,0.1); padding: 5px 10px; border-radius: 5px;">{{ $edu->getFormattedStartDate() }} - {{ $edu->getFormattedEndDate() ?? __("Davam edir") }}</span>
                                                        </div>
                                                    </div>
